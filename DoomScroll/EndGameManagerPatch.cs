...
namespace DoomScroll
{
    ...
    class EndGameManagerPatch
    {
        ...
        {
            __instance.WinText.text += "\n<size=40%><color=\"white\"> { SWC Results } </size><size=20%>" + SecondaryWinConditionHolder.getSomePlayerSWC(PlayerControl.LocalPlayer._cachedData.PlayerId).SWCResultsText() + "</color></size>";
