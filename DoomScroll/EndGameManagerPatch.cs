...
namespace DoomScroll
{
    ...
    class EndGameManagerPatch
    {
        ...
        {
            __instance.WinText.text += "\n<size=20%><color=\"white\">" + SecondaryWinConditionHolder.getSomePlayerSWC(PlayerControl.LocalPlayer._cachedData.PlayerId).SWCAssignText() + ": " + SecondaryWinConditionHolder.getSomePlayerSWC(PlayerControl.LocalPlayer._cachedData.PlayerId).SWCResultsText() + "</color></size>";
